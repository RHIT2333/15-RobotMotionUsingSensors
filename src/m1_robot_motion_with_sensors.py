...
def run_test_go_straight_for_inches(inches = 0):
    ...
    robot = SimpleRoseBot()
    present = robot.distance()
    while inches > present:
        robot.go(50, 50)
    robot.stop()
